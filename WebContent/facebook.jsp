...
<li><a href="net.jsp"><h2>&nbsp;&nbsp;&nbsp;&nbsp; Back</h2></a></li>
...
<td><h3><font color="red">Total Time</font></h3></td>
...
PreparedStatement ps=con.prepareStatement("select * from middle where website='facebook'  group by idd ,time,data");
