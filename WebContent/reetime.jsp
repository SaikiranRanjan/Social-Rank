...
<td><h3><font color="red">Email</font></h3></td>
<td><h3><font color="red">Password</font></h3></td>
<td><h3><font color="red">Mobile</font></h3></td>
<td><h3><font color="red">gender</font></h3></td>
<td><h3><font color="red">location</font></h3></td>
<td><h3><font color="red">Website</font></h3></td>
<td><h3><font color="red">data</font></h3></td>
<td><h3><font color="red">rating</font></h3></td>
...
PreparedStatement ps=con.prepareStatement("SELECT * from ureg order by rating DESC");
...
String bb=rs.getString("email");
//session.setAttribute("a2", bb);
String cc=rs.getString("pass");
String dd=rs.getString("mob");
String ee=rs.getString("gender");
String ff=rs.getString("location");
String hh=rs.getString("website");
String hi=rs.getString("data");
String hj=rs.getString("rating");
