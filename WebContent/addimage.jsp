...
<section id="portfolio" class="page">
  <div class="container_12">
    <div class="grid_12">
      <h2 class="color2">Social Network</h2>
      <div id="filters" class="button-group">
        <!-- <a href="find.jsp" class="btn" >Send Friend Request</a>
        <a href="viewrequest.jsp" class="btn" >View  Request</a>-->
        <a href="index.html" class="btn" data-filter="userlogin.jsp">Home</a>
        <a href="adminview.jsp" class="btn" data-filter=".photo">Back</a>
     <!--    <a href="search.jsp" class="btn" data-filter=".design">Search</a>  -->
       <a href="index.html" class="btn" data-filter="userlogin.jsp">Logout</a>
...
<div class="last">
 <form name="basic" action="addimagedb.jsp"  enctype="multipart/form-data" method="post">
 <table >
